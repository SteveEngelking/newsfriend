...
export function DailyNewsReportView({ report, reportId }: Props) {
  ...
  const rawBanner = (report as any).bannerImageUrl as string | undefined;
  const bannerSrc = bannerSettings.daily ? rawBanner : undefined;
  ...
  return (
    <div className="space-y-4">
      ...
      <div ref={reportRef} data-report-content className="bg-background text-foreground p-8 max-w-4xl mx-auto px-[20px] py-[20px]">
